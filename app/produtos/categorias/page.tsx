  ...
  return (
    <main className="updv-page">
      <PageHeader
        ...
        actions={
          <a
            href="/produtos/categorias?novo=1"
      ...
      {mostrarFormulario && (
        <section className="mx-4 mt-3 rounded-md border border-zinc-200 bg-white p-4">
          <h2 className="text-[15px] font-semibold">
            {registroEdicao ? "Editar categoria" : "Nova categoria"}
          </h2>

          <form
            action={registroEdicao ? editarCategoria : cadastrarCategoria}
          ...
          >
            ...
            <div className="flex items-end gap-2">
              ...
              <a href="/produtos/categorias" className="updv-btn updv-btn-ghost">
                Cancelar
              </a>
            </div>
          </form>
        ...
        <tbody>
          {registros?.map((registro) => (
            <tr key={registro.id}>
              <td>
                <RowActions
                  editHref={`/produtos/categorias?editar=${registro.id}`}
                  extra={
