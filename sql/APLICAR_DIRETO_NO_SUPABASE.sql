...
-- ============================================================
-- UltraPDV
-- Força atualização da RPC de cancelamento para remover RECORD
-- opcional v_titulo em vendas sem FIADO.
--
-- Este timestamp novo existe porque a migration 20260813173000
-- não entrou no banco remoto.
-- ============================================================
