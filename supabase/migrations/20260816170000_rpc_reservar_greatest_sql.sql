...
-- Reserva: GREATEST/COALESCE como sintaxe SQL.
-- Claim: COALESCE como sintaxe SQL.
-- Com search_path vazio, chamadas schema-qualified dessas
-- expressões especiais falham. Lógica de numeração inalterada.
