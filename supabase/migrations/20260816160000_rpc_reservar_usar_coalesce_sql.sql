...
-- Usa COALESCE (sintaxe SQL) na reserva. search_path vazio não resolve
-- chamada schema-qualified com bigint e integer misturados.
-- Assinatura, locks, idempotência e regra de numeração inalteradas.
