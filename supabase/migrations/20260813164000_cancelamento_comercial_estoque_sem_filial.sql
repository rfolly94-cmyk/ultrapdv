...
begin
  ...
  -- ----------------------------------------------------------
  -- Estoque — UltraPDV atual SEM filial
  --
  -- Fonte da devolução: vendas_itens.
  -- Saldo operacional: estoque_atual por empresa + produto.
  -- Não usa filial_id, documento_tipo nem documento_id.
  -- ----------------------------------------------------------
